...
它不负责说明 agent 应该按什么流程工作，那是 [AGENTS.md](../../AGENTS.md) 的职责；也不负责定义工程短规则，那是 [RULES.md](../../RULES.md) 的职责；Validation 和 runner 绑定应进入验证入口、hook、CI、linter runtime 或对应 artifact；长篇产品背景和设计讨论应放在 [README.md](../../README.md) 或 [docs/](../) 中。
...
- 工程短规则放在 [RULES.md](../../RULES.md)；Validation 和 runner 证据放在验证入口、hook、CI、linter runtime 或对应 artifact。
