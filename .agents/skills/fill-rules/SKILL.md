...
5. Store rationale, evidence, validation context, runner bindings, caveats, and examples inside the `## Details` section of `.harnesskit/rules/<RULE-ID>.md`; do not require a separate `## Validation` heading.
