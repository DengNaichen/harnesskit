...
- RULE-STYLE-001: [NEEDS CLARIFICATION: 记录本仓库需要保护的代码风格、模块边界或重构边界。] ([details](.harnesskit/rules/RULE-STYLE-001.md))
...
- RULE-PRODUCT-001: [NEEDS CLARIFICATION: 记录本仓库关于用户可见能力、文案真实性或生成资产状态边界的硬约束。] ([details](.harnesskit/rules/RULE-PRODUCT-001.md))

## 安全规则

- RULE-SEC-001: 不要把 secret、token、私有凭据或机器特定敏感信息写入模板、facts、rules、报告或生成产物。([details](.harnesskit/rules/RULE-SEC-001.md))
- RULE-SEC-002: [NEEDS CLARIFICATION: 记录本仓库文件写入、覆盖行为、路径安全或外部状态修改的硬约束。] ([details](.harnesskit/rules/RULE-SEC-002.md))
